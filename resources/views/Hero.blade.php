  ...
  <section class="jumbotron text-center">
            <img src="{{ Url ('ea70b9dd00c6a7ec4fbcea85d217e576.jpg') }}" alt="aaa" width="200" class="rounded-circle img-thumbnail">
            <h1 class="display-4">Reyhan Besty Putra</h1>
            <p class="lead">12 RPL 2 | Absen 28</p>
        </section>
